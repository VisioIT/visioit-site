...
export default function Home() { return <main id="conteudo">
  ...
  <header className="site-header"><a className="brand" href="#inicio" aria-label="Visio IT, início"><Image src="/visio-logo-menu.png" width={1910} height={578} alt="Visio IT" priority /></a><nav aria-label="Navegação principal"><a href="#servicos">Serviços</a><a href="#clientes">Clientes</a><a href="#contato">Contato</a><a href="/blog">Blog</a></nav><a className="header-contact" href={whatsapp} target="_blank" rel="noreferrer">Fale com a Visio <span aria-hidden="true">↗</span></a></header>
